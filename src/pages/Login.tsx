        ...
        <div className="max-w-md w-full space-y-8 glass p-8 rounded-xl">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-muted-foreground">
              ...
              <Link to="/register" className="text-fashion-sage hover:text-fashion-charcoal font-medium">
                Sign up
              </Link>
            </p>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-sm text-fashion-sage hover:text-fashion-charcoal">
                    Forgot password?
                  </Link>
                </div>
